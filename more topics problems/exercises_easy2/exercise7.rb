...
# to each_with_object; with each iteration, this object may be updated by the
...
def each_with_object(collection, result)
  collection.each { |element| yield(element, result) }
  result
end
