# exercise4.rb - Passing Parameters Part 2
...
# argument. The method should yield the contents of the array to a block,
...
ignore_first_two(birds) { |bird| bird[2..-1] }

birds_again = %w(raven finch hawk eagle)

def types(arr)
  yield(arr)
end

types(birds_again) do |_, _, *raptors|
