...
# access it. However, when a method is protected, only instances of the class
# or a subclass can call the method. This means we can easily share sensitive
# data between instances of the same class type.
