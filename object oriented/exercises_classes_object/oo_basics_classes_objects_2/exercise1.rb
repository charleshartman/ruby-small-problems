# exercise1.rb - Generic Greeting (Part 1)
...
# method. In our solution, we place puts 'Hello! I'm a cat!' so that Hello!
# I'm a cat! is printed when #generic_greeting is invoked.
