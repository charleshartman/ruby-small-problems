...
# can only be invoked from within the class. We can define methods as private
# by calling private before the method definition.
...
# can't be invoked from outside the class.
