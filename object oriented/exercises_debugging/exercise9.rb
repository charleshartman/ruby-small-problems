...
module Mailing
  ...
  def mailing_send(destination, mail)
...
puts johns_postal_service.mailing_send(ellens_postal_service.street_address, \
...
p rafaels_email_account.account_number
p johns_phone_service.account_number
