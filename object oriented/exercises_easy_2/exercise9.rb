...
# has-a relationship. While it is sometimes tricky to choose one or the other,
# a great guideline is to decide if you want some additional functionality, or
# if you want to extend the abilities of the class. In this case, it is pretty
# clear that we need the functionality of walking; we don't need to extend the
# abilities of class Person(extending the abilities of a class coincides with
# an is-a relationship, not has-a).
