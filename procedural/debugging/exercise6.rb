# exercise6.rb - Getting Things Done
...
p done # should be: ['apply sunscreen', 'go to the beach', 'study',
#                    'walk the dog']

# with no terminating condition to stop it, the recursive method call loops
